...
class LearnScreen extends StatelessWidget {
  ...
  //                       decoration: BoxDecoration(
  //                         borderRadius: BorderRadius.circular(20),
  //                         border: Border.all(color: Colors.cyan, width: 4), // Red border
  //                       ),
  //                       child: ClipRRect(
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            // You can keep the content here or remove it if needed
          ),
          Padding(
            padding: EdgeInsets.only(top: 20, left: 15, right: 15),
            child: Column(
...
onTap: () {
  ...
  if (index == 0) {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => MalwareScreen()), // Navigate to the TipsScreen
    );
  } else if (index == 2) {
    Navigator.push(
      context,
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => MalwareScreen()), // Navigate to the NewsScreen
    );
  }
},
